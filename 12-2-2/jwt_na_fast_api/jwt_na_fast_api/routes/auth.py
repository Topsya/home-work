...
from jwt_na_fast_api.schemas import UserModel, UserResponse, TokenModel, RequestEmail
from jwt_na_fast_api.repository import users as repository_users
from jwt_na_fast_api.services.auth import auth_service
from jwt_na_fast_api.services.emailtogo import send_email
...
async def request_email(body: RequestEmail, background_tasks: BackgroundTasks, request: Request,
    ...
    :param body: RequestEmail: Pass the email to be confirmed
